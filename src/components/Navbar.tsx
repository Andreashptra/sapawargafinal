...
export default function Navbar() {
  ...
  const navRef = useIOSSafeArea<HTMLElement>()

  return (
    <nav ref={navRef} className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-100 shadow-sm">
